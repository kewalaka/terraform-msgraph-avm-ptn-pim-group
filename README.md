...
- [msgraph_resource.pim_policy_assignment](https://registry.terraform.io/providers/microsoft/msgraph/latest/docs/resources/resource) (resource)
...
### <a name="input_create_pim_policy_assignment_if_missing"></a> [create\_pim\_policy\_assignment\_if\_missing](#input\_create\_pim\_policy\_assignment\_if\_missing)

Description: If true, attempt to create a roleManagementPolicyAssignment for this Group scope and pim\_role\_id (member/owner). Requires PIM for Groups enabled in the tenant. Leave false to avoid first-apply failures when the feature isn't enabled.
...
### <a name="input_manage_pim_policy_rules"></a> [manage\_pim\_policy\_rules](#input\_manage\_pim\_policy\_rules)
